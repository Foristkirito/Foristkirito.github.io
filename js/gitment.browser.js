...
function renderEditor(_ref3, instance) {
  ...
  writeTab.onclick = function () {
    ...
    var triangle = document.querySelectorAll('.gitment-editor-main')[0];
    triangle.classList.add('gitment-white-triangle');
    textarea.focus();
  };
  previewTab.onclick = function () {
    ...
    var triangle = document.querySelectorAll('.gitment-editor-main')[0];
    triangle.classList.remove('gitment-white-triangle');
...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      _utils.http.post('https://foristkirito.site', {
        code: code,
        client_id: client_id,
